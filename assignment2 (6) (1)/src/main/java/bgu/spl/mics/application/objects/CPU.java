...
public class CPU {
    ...
    public int getWaitingTime() {
            int waitingTime = -1;
            if (toProcess != null) {
                if (toProcess.getValue() != null) {
                    if (toProcess.getValue().getModel() != null) {
                        if (toProcess.getValue().getModel().getData().getType().equals(Data.Type.Images)) {
                            waitingTime = (32 / cores) * 4;
                        } else if (toProcess.getValue().getModel().getData().getType().equals(Data.Type.Text)) {
